...
#define LIBWC_OBJECT_STRING_VARIANT_TYPE (G_VARIANT_TYPE(LIBWC_OBJECT_STRING_VARIANT_TYPE_STR))
#define LIBWC_OBJECT_BUFFER_VARIANT_TYPE (G_VARIANT_TYPE(LIBWC_OBJECT_BUFFER_VARIANT_TYPE_STR))
